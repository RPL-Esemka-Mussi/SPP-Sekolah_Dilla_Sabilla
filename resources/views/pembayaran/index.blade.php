                    ...
                    @foreach ($siswa as $data)
                        <tr>
                            ...
                            <td>
                                ...
                                <a href='{{ url("pembayaran/history/$data->id") }}' class="btn btn-info btn-sm"><i class="bi bi-clock-history"></i> History</a>
                                    @else
                                    <a href='{{ url("pembayaran/transaksi/$data->id") }}' class="btn btn-primary btn-sm"><i class="bi bi-credit-card"></i> Transaksi</a>
                                @endif
                                @can('admin')
                                    <a href='{{ url("pembayaran/cetak/$data->id") }}' class="btn btn-info btn-sm"><i class="bi bi-printer"></i> Print Id</a>
                                @endcan
                            </td>
                        </tr>
                    @endforeach
